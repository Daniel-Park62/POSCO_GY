...
UPDATE motestatus SET 
 ...
 prtd1 = case when errflag1 = 1 and prtd1 = 0 then prtd1 ELSE NEW.rtd1 end,
 ...
 prtd2 = case when errflag2 = 1 and prtd2 = 0 then prtd2 ELSE NEW.rtd2 end,
 ...
 prtd3 = case when errflag3 = 1 and prtd3 = 0 then prtd3 ELSE NEW.rtd3 end,
...
WHERE mmgb = NEW.mmgb AND seq = NEW.seq AND ( stand = 0 OR act = 0 ) ;
