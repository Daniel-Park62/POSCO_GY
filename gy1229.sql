...
UPDATE motestatus SET 
 errflag1 = case when errflag1 = 0 AND ( NEW.rtd1 <= 0 OR NEW.rtd1 = 1.9 OR NEW.rtd1 > 200 OR ( ABS(prtd1 - NEW.rtd1) > 15 and errcnt1 > 1)) then 1 ELSE errflag1 END,
 ...
 errflag2 = case when cntgb = 1 and errflag2 = 0 AND ( NEW.rtd2 <= 0 OR NEW.rtd2 = 1.9 OR NEW.rtd2 > 200 OR ( ABS(prtd2 - NEW.rtd2) > 15 and errcnt2 > 2)) then 1 ELSE errflag2 END,
 ...
 errflag3 = case when cntgb = 1 AND (seq MOD 2) = 1 AND errflag3 = 0 AND ( NEW.rtd3 <= 0 OR NEW.rtd3 = 1.9 OR NEW.rtd3 > 200 OR ( ABS(prtd3 - NEW.rtd3) > 15 and errcnt3 > 1)) then 1 ELSE errflag3 END,
